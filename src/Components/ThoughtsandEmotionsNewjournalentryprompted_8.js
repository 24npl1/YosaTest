...
import './ThoughtsandEmotionsNewjournalentryprompted_8.css'
import ImgAsset from '../public'
import notifications from "./notifications"
export default function ThoughtsandEmotionsNewjournalentryprompted_8 () {
	return (
		<div className='ThoughtsandEmotionsNewjournalentryprompted_8_ThoughtsandEmotionsNewjournalentryprompted'>
			<notifications className='notifications'/>
			<div className='Retangle'>
				<img className='Rectangle36' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_8_Rectangle36} />
				...
				<img className='Rectangle37' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_8_Rectangle37} />
			...
			<div className='HomeBar'>
				...
				<div className='ButtonHome'>
					<div className='Home'>
						<img className='Rectangle2' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_8_Rectangle2} />
					</div>
				</div>
			</div>
		</div>

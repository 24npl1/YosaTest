...
import './ThoughtsandEmotionsNewjournalentryprompted_2.css'
import ImgAsset from '../public'
import notifications from "./notifications"
export default function ThoughtsandEmotionsNewjournalentryprompted_2 () {
	return (
		<div className='ThoughtsandEmotionsNewjournalentryprompted_2_ThoughtsandEmotionsNewjournalentryprompted'>
			<notifications className='notifications'/>
			<div className='Retangle'>
				<img className='Rectangle36' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_2_Rectangle36} />
				...
				<img className='Rectangle37' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_2_Rectangle37} />
			...
			<div className='HomeBar'>
				...
				<div className='ButtonHome'>
					<div className='Home'>
						<img className='Rectangle2' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_2_Rectangle2} />
					</div>
				</div>
			</div>
		</div>

...
import './HomePagefirstversion.css'
import ImgAsset from '../public'
import notifications from "./notifications"
export default function HomePagefirstversion () {
	return (
		<div className='HomePagefirstversion_HomePagefirstversion'>
			...
			<div className='SleepMeditationtabs'>
				...
				<img className='Rectangle25' src = {ImgAsset.HomePagefirstversion_Rectangle25} />

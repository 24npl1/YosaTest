...
import './ThoughtsandEmotionsNewjournalentryprompted_3.css'
import ImgAsset from '../public'
import notifications from "./notifications"
export default function ThoughtsandEmotionsNewjournalentryprompted_3 () {
	return (
		<div className='ThoughtsandEmotionsNewjournalentryprompted_3_ThoughtsandEmotionsNewjournalentryprompted'>
			<notifications className='notifications'/>
			<div className='Retangle'>
				<img className='Rectangle36' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_3_Rectangle36} />
				...
				<img className='Rectangle37' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_3_Rectangle37} />
			...
			<div className='HomeBar'>
				...
				<div className='ButtonHome'>
					<div className='Home'>
						<img className='Rectangle2' src = {ImgAsset.ThoughtsandEmotionsNewjournalentryprompted_3_Rectangle2} />
					</div>
				</div>
			</div>
		</div>
